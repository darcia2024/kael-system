  ...
  const verifyStaffPin = (pin: string) => {
    ...
    setTimeout(() => {
      ...
      if (authResult.success) {
        ...
        setStaffError(authResult.error || "PIN tidak valid.");
        setStaffPin("");
      }
    }, 400);
  };
